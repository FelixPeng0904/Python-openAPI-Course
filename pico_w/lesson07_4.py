...
def alert(temp):
    ...
    if time.ticks_diff(time.ticks_ms(),start_time) >= duration * 1000: # 1000ms = 1s
        ...
        url_str = f'https://hook.us1.make.com/1khpve1tymy2jk7aw47o7a1v14beob99?data={date_str}&temperature={temp}&from=學院養豬場'
        try:
